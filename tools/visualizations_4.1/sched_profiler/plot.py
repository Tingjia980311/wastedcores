...
cpu_list = [i for i in range(40)]
cpu_qlens_matrix = cpu_qlens_matrix[cpu_list,1002500:1003500]
print(cpu_qlens_matrix.shape)
sns.set(rc = {'figure.figsize':(40, 8)}, font_scale=1.8)
ax = sns.heatmap(cpu_qlens_matrix, cmap="Blues")
plt.savefig("part_output_" + cpu_n + "_" + file_id + ".png")
